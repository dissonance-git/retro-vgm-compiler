...
> Historical note: this document is preserved for lineage. Current architecture and implementation direction are owned by `README.md`, `AGENTS.md`, `CATALOG.md`, and `docs/retro-vgm-compiler-roadmap.md`.
