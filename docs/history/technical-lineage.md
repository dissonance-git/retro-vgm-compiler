...
> Historical note: this document preserves lineage. Current architecture is owned by `README.md`, `AGENTS.md`, `CATALOG.md`, and `docs/retro-vgm-compiler-roadmap.md`.
